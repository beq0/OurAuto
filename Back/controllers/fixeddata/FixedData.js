...
const categories = [
    "სედანი", "ჯიპი", "კუპე", "ჰეჩბექი", "უნივერსალი", "კაბრიოლეტი", "პიკაპი", "მინივენი", "მიკროავტობუსი",
    "ფურგონი", "ლიმუზინი"
];
...
const transmissions = [
    "მექანიკა", "ავტომატიკა", "ტიპტრონიკი", "ვარიატორი"
]
...
const fuelTypes = [
    "ბენზინი", "დიზელი", "ელექტრო", "წყალბადი", "ჰიბრიდი", "დატენვადი ჰიბრიდი", "ბუნებრივი გაზი", "თხევადი გაზი"
]
